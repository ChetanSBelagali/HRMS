...
public class FileStorageService {
	...
	public String storeFile(MultipartFile file, CreateCandidateRequest createCandReq) {
		// Normalize file name
		String fileName = createCandReq.getCandEmail()+"_"+StringUtils.cleanPath(file.getOriginalFilename());
